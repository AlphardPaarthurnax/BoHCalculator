...
import com.github.alphardpaarthurnax.bohcalculator.database.SdeGeneratorService;
...
public class DataGeneratorController {
    ...
    private void reloadCatalogs() {
        ...
        WallartDataService.getInstance().reload();
        ComfortDataService.getInstance().reload();
        ThingDataService.getInstance().reload();
        BookDataService.getInstance().reload();
